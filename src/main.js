...
function createWindow() {
    ...
    electron_1.ipcMain.on('getSerialPorts', function () { return __awaiter(_this, void 0, void 0, function () {
        var arduinoPath, LARITPath, LARIT;
